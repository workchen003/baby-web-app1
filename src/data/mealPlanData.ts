...
export interface Recipe {
  ...
  // --- vvv 新增欄位 vvv ---
  allergens?: ('egg' | 'fish' | 'nuts' | 'dairy' | 'gluten')[]; // 定義可能的過敏原
  // --- ^^^ 新增欄位 ^^^ ---
}
...
export const mealPlanData: AgeStagePlan[] = [
  ...
  },
  {
    ...
    recipes: [
      ...
      // --- vvv 標示過敏原 vvv ---
      { name: '蛋黃泥', category: 'protein', caloriesPerGram: 3.22, allergens: ['egg'] },
      // --- ^^^ 標示過敏原 ^^^ ---
  ...
  },
  {
    ...
    recipes: [
      ...
      // --- vvv 標示過敏原 vvv ---
      { name: '鮭魚', category: 'protein', caloriesPerGram: 2.08, allergens: ['fish'] },
      // --- ^^^ 標示過敏原 ^^^ ---
  ...
  },
  {
    ...
    recipes: [
        ...
        // --- vvv 標示過敏原 vvv ---
        { name: '寶寶麵', category: 'staple', caloriesPerGram: 1.38, allergens: ['gluten'] },
        { name: '起司片', category: 'protein', caloriesPerGram: 4.02, allergens: ['dairy'] },
        // --- ^^^ 標示過敏原 ^^^ ---
        { name: '雞腿肉塊', category: 'protein', caloriesPerGram: 1.70 },
        { name: '炒青菜', category: 'vegetable', caloriesPerGram: 0.40 },
        { name: '各種水果', category: 'fruit', caloriesPerGram: 0.60 },
    ],
  },
];